...
`;
        ...
        <div class="user-panel relative flex items-center ml-3">
            ...
            <div class="dropdown-menu absolute right-0 z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600">
